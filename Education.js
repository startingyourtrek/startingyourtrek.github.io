...
//sets variables equal to a column of the spreadsheet
			if (data[i]["category"]==="Educational"){//calls all the rows that have summer as its category
				document.write( "<div><br/>Title: " + title +   "<br/>Info: " + description + " " + bio + " " + qualifications + "<br/>Link: " + link + " </div>" );// prints out those rows
			}}}
